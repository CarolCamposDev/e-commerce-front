                ...
                <tbody>
                  {dados.map((dado) => (
                    <tr key={dado.id}>
                      ...
                      <td>{dado.nome}</td>
                      <td>{dado.email}</td>
                      <td>{dado.endereco ? `${dado.endereco.logradouro}, ${dado.endereco.numero}, ${dado.endereco.complemento}, ${dado.endereco.bairro}, ${dado.endereco.cidade}, ${dado.endereco.uf}, ${dado.endereco.cep}` : ''}</td>
                      <td>
